...
#include "prius_msgs/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prius_msgs
cdr_serialize(
  const prius_msgs::msg::Control & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prius_msgs::msg::Control & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const prius_msgs::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<prius_msgs::msg::Control *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_prius_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<prius_msgs::msg::Control>()
{
  return &prius_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prius_msgs, msg, Control)() {
  return &prius_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
